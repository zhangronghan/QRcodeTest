...
public class MyDecoratedBarcodeView extends FrameLayout {
    ...
    private void initialize(AttributeSet attrs) {
        ...
        barcodeView = (MyBarcodeView) findViewById(com.google.zxing.client.android.R.id.zxing_barcode_surface);
        ...
        //com.google.zxing.client.android.R.id.zxing_viewfinder_view
        if (viewFinder == null) {
            throw new IllegalArgumentException(
